...
public class InputHandlingNativeDependencyResolver implements
		NativeDependencyResolver {
	private final NativeDependencyResolver delegate;

	public InputHandlingNativeDependencyResolver(
	...
	public void resolve(NativeBinaryResolveResult nativeBinaryResolveResult) {
		for (NativeBinaryRequirementResolveResult resolution : nativeBinaryResolveResult
			...
			if (resolution.getInput() instanceof NativeDependencySet) {
				resolution
						.setNativeDependencySet((NativeDependencySet) resolution
								.getInput());
			}
		}
