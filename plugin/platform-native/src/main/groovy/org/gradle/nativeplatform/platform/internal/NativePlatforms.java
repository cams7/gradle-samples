...
public class NativePlatforms {
	...
	private static DefaultNativePlatform createPlatform(
			OperatingSystemInternal os, ArchitectureInternal arch) {
		return new DefaultNativePlatform(platformName(os.getName(),
				arch.getName()), os, arch);
	}
	...
	public static String getDefaultPlatformName() {
		NativePlatformInternal defaultPlatform = new DefaultNativePlatform(
				"default");
		...
		// TODO:DAZ This is a very limited implementation of defaults, just to
