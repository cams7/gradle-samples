...
public class CompilerMetaDataProviderFactory {
	...
	public CompilerMetaDataProviderFactory(final FileLookup fileLookup) {
		...
		gcc = new CachingCompilerMetaDataProvider(
				GccVersionDeterminer.forGcc(factory));
		clang = new CachingCompilerMetaDataProvider(
				GccVersionDeterminer.forClang(factory));
	}
	...
	private static class CachingCompilerMetaDataProvider implements
		...
		private CachingCompilerMetaDataProvider(
				CompilerMetaDataProvider delegate) {
