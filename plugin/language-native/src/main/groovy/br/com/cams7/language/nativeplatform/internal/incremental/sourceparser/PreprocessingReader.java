 ...
 */
package br.com.cams7.language.nativeplatform.internal.incremental.sourceparser;
...
/**
 * Replaces c-style comments with a single space, and removes line-continuation
 * characters. This code is largely adopted from
 * org.apache.tools.ant.filters.StripJavaComments.
 *
 * This avoids the synchronisation overhead of PushbackReader and is _not_
 * threadsafe.
 */
public class PreprocessingReader extends BaseFilterReader {
	/**
	 * The read-ahead characters, used for reading ahead up to 2 characters and
	 * pushing back into stream. A value of -1 indicates that no character is in
	 * the buffer.
	 */
