...
/**
 * Represents a binary artifact that is the result of building a project
 * component.
 */
@Incubating
@HasInternalProtocol
public interface BinarySpec extends BuildableModelElement, Named {
	...
	/**
	 * Adds one or more {@link org.gradle.language.base.LanguageSourceSet}s that
	 * are used to compile this binary.
	 * <p/>
