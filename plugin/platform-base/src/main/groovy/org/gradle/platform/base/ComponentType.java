 ...
 *
 * The following example demonstrates how to register a custom component type
 * using a plugin with a {@link ComponentType} annotation. Furthermore the
 * plugin creates an instance of SampleComponent named 'sampleComponent'.
 *
 * <pre autoTested='true'>
