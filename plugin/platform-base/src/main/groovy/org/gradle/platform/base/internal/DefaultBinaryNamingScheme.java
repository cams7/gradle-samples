...
public class DefaultBinaryNamingScheme implements BinaryNamingScheme {
	...
	public DefaultBinaryNamingScheme(String parentName, String typeString,
	...
	public String getOutputDirectoryBase() {
		StringBuilder builder = new StringBuilder(makeName(parentName,
				typeString));
	...
	private void appendCapitalized(StringBuilder builder, String word) {
		...
		builder.append(Character.toTitleCase(word.charAt(0))).append(
				word.substring(1));
	}
	...
	private void appendUncapitalized(StringBuilder builder, String word) {
		...
		builder.append(Character.toLowerCase(word.charAt(0))).append(
				word.substring(1));
	}
}
