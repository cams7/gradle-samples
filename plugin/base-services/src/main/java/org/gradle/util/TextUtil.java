...
public class TextUtil {
	...
	/**
	 * Converts all line separators in the specified string to the specified
	 * line separator.
	 */
	...
	/**
	 * Converts all line separators in the specified string to the platform's
	 * line separator.
	 */
	...
	/**
	 * Converts all line separators in the specified string to a single new line
	 * character.
	 */
	...
	/**
	 * Escapes the toString() representation of {@code obj} for use in a literal
	 * string. This is useful for interpolating variables into script strings,
	 * as well as in other situations.
	 */
	public static String escapeString(Object obj) {
		return obj == null ? null : StringEscapeUtils
				.escapeJava(obj.toString());
	}
	...
	/**
	 * Indents every line of {@code text} by {@code indent}. Empty lines and
	 * lines that only contain whitespace are not indented.
	 */
